...
//   };
  ...
  return (
    <div className="">
      {/* <h1 className="id-card-title">Student ID Card Generator</h1> */}
      
      {/* Batch Download Buttons */}
      {/* <div className="mb-6 flex justify-center gap-4">
        <button
          onClick={() => handleBatchDownload('batch-png')}
          className="batch-button-png"
      ...
      {/* List of Students with Individual Download Buttons */}
      <div className="">
        {students.map((student, index) => (
          <div key={index} className="">
            {/* <h3 className="student-name">{student.name}</h3>
            <p className="student-info">ID: {student.id}</p>
            <p className="student-info">Grade: {student.grade}</p> */}
            <div className="mt-2 flex gap-2">
              <button
                onClick={() => handleDownload(student, 'png')}
